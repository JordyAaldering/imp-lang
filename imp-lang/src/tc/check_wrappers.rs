...
///
/// 3) there must be a strict ordering in the 'preciseness' of overloads that only differ in their type patterns.
...
///
///    For example, this is not allowed for bar(u32[o:oshp,i:ishp] a, u32[o:oshp] b) and bar(u32[o:oshp] a, u32[o:oshp,i:ishp] b).
